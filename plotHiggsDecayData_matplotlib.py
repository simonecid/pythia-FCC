...
higgsPtCanvas.savefig(argv[0] + "_higgsPtPlot.svg")
...
ewBosonPtCanvas.savefig(argv[0] + "_ewBosonPtPlot.svg")
...
ewBosonLeadingPtCanvas.savefig(argv[0] + "_ewBosonLeadingPtPlot.svg")
...
ewBosonSubLeadingPtCanvas.savefig(argv[0] + "_ewBosonSubLeadingPtPlot.svg")
...
ewBosonsPtCanvas.savefig(argv[0] + "_ewBosonsPtPlot.svg")
...
chargedLeptonPtCanvas.savefig(argv[0] + "_chargedLeptonPtPlot.svg")
...
neutralLeptonPtCanvas.savefig(argv[0] + "_neutralLeptonPtPlot.svg")
...
leptonsPtCanvas.savefig(argv[0] + "_leptonsPtPlot.svg")
...
higgsEtaCanvas.savefig(argv[0] + "_higgsEtaPlot.svg")
...
ewBosonEtaCanvas.savefig(argv[0] + "_ewBosonEtaPlot.svg")
...
chargedLeptonEtaCanvas.savefig(argv[0] + "_chargedLeptonEtaPlot.svg")
...
higgsPhiCanvas.savefig(argv[0] + "_higgsPhiPlot.svg")
...
ewBosonPhiCanvas.savefig(argv[0] + "_ewBosonPhiPlot.svg")
...
chargedLeptonPhiCanvas.savefig(argv[0] + "_chargedLeptonPhiPlot.svg")