...
canvas.Print(argv[1] + "_ptHistogramComparison_1.svg", "svg")
...
canvas.Print(argv[1] + "_ptHistogramComparison_2.svg", "svg")

resonanceEtaHisto.Draw()
resonanceEtaHisto.Write()
canvas.Update()
canvas.Print(argv[1] + "_resonanceEtaHisto.png", "png")
canvas.Print(argv[1] + "_resonanceEtaHisto.svg", "svg")
decayEtaHisto.Draw()
decayEtaHisto.Write()
canvas.Update()
...
canvas.Print(argv[1] + "_decayLeadingEtaHisto.svg", "svg")

resonancePhiHisto.Draw()
resonancePhiHisto.Write()
canvas.Update()
canvas.Print(argv[1] + "_resonancePhiHisto.png", "png")
canvas.Print(argv[1] + "_resonancePhiHisto.svg", "svg")
decayPhiHisto.Draw()
decayPhiHisto.Write()
canvas.Update()
